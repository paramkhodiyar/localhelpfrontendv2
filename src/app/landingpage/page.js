            ...
            <div className="flex-1 space-y-8">
              ...
              <div className="flex items-center justify-around bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600 mt-1">Verified Providers</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  description: "99% customer satisfaction with our quality assurance program"
                },
                {
                  icon: FaHeadset,
                  title: "24/7 Support",
              ...
              {[
                {
                  ...
                  rating: 5,
                  comment: "Excellent service! The cleaner was professional and thorough. Will definitely book again."
                },
                {
                  name: "Rajesh Kumar",
                  service: "Computer Repair",
                  rating: 5,
                  comment: "Fixed my laptop in no time. Very knowledgeable and affordable. Highly recommended!"
                },
                {
                  name: "Anita Desai",
                  service: "Pet Care",
                  rating: 5,
                  comment: "My dog absolutely loved the caretaker. Professional and caring service."
                }
              ].map((testimonial, idx) => (
                <div key={idx} className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
                  ...
                  <div>
                    <p className="font-semibold text-[#4a2e21]">{testimonial.name}</p>
        ...
        <div className="bg-[#4a2e21] py-16">
          <div className="max-w-4xl mx-auto px-6 lg:px-10 text-center">
            ...
            <p className="text-gray-300 mb-8">
              Join thousands of satisfied customers who trust us with their daily needs
            </p>
